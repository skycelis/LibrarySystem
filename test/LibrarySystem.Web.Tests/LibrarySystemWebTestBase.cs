...
{
    public abstract class LibrarySystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibrarySystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibrarySystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibrarySystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibrarySystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibrarySystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibrarySystemDbContext, Task<T>> func)
        {
            T result;
